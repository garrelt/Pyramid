...
contains
  ...
  subroutine pyramid_global_to_source_transformation()
  ...
  end subroutine pyramid_global_to_source_transformation	  

  subroutine pyramid_source_to_global_transformation()
  ...
  end subroutine pyramid_source_to_global_transformation 
...
end module coordinate_transformation