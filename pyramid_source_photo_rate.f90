module pyramid_source_photo_rate
...
contains
  ...
  subroutine pyramid_source_HI_photo_rate_calculation()
  ...
  end subroutine pyramid_source_HI_photo_rate_calculation
...
end module pyramid_source_photo_rate